#include <iostream>
 ...
 int main(int argc, char*  argv[])
 {
   ...
   SACommand cmd(&con,"Select name, roll from v");      /* create command object, this is line in which we will select field which is to be viewed in output give (table name here)*/ \
   try
   {
      // connect to MySQL database
      con.Connect(
      "vasu",  // database name change as per your database  name
