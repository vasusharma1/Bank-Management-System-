                ...
                case 2:
                 {
                     ...
                     string v;
                            string pass;
                                    ...
                                    cin>>pass;
                                    SACommand cmd(&con,"Select balance from v where uname=:9 AND password=:22");
                                    ...
                                    system("pause");
                                    system("cls");
                                    cout<<"Your account balance is :->"<<"RS."<<v<<"/-"<<endl<<endl<<endl;
                                    system("pause");
                                    break;
                                    }
                                    if(cmd.FetchNext()==0)
                    ...
                    case 3:
                    {
                                    ...
                                    cin>>b.wit;
                                    SACommand cmd(&con,"update v set balance=balance-:7 where uname=:6");
                                    ...
                                    cin>>b.wit1;
                                    SACommand cmd(&con,"update v set balance=balance+:8 where uname=:9");
                    ...
                    case 4:
                    {
                        ...
                        cin>>b.po;
                        SACommand cmd(&con,"update v set password=:13 where uname=:14");
                    ...
                    case 6:
                    {
                        SACommand cmd(&con,"Select name,uname,balance from v");
                        cmd.Execute();
                        int i=0;
                            bool is_result = cmd.isResultSet();
                            long col_count = cmd.FieldCount();
